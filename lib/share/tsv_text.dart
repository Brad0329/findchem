...
/// [entry] 한 건의 TSV: **머리글 없이** 수량 행 수만큼(2026-09-12 사용자 요청 — 여러 건을 이어 붙일 때
/// 머리글이 중간에 끼지 않게). 열 순서는 화면 표와 같다:
/// 연번·화학물질명·CAS번호·고유번호·구분·함량기준(% 이상)·최하위·하위·상위 9개
/// ('표'·'영문명' 열은 넣지 않는다 — 어느 표인지는 '구분' 칸이 차 있는지로 안다).
/// 앞 4칸(연번~고유번호)은 매 줄 반복한다(Excel에서 정렬·필터가 바로 되게).
